...
<script lang="ts">
import { defineComponent, reactive, toRefs, ref, onMounted, computed, onActivated } from 'vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      console.log('onMounted personalCenter.vue')
      getTagList()
    })
    onActivated(() => {
      console.log('onActivated personalCenter.vue')
    })
    return {
      formLabelWidth,
      showInput,
