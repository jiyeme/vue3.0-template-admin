      ...
      <div class="bar">
        <el-tooltip content="打开" placement="left-end" effect="light">
          <div class="operator" @click="openFile">
            ...
            >
              ...
              <path d="M21.5 16.5h-3v-3h-2v3h-3v2h3v3h2v-3h3z" />
              <path
                d="M4.5 4.5h14v8h2v-8c0-1.1-.9-2-2-2h-14c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2h-8v-14z"
              />
            </svg>
            <input
              ref="filElem"
        ...
        <el-tooltip content="上下翻转" placement="top" effect="light">
          <div ref="flipY" class="text" @click="handleFlipY()">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" class>
              <path fill-rule="evenodd" d="M7 0l4 4H3l4-4zM3 10h8l-4 4-4-4zM0 8V6h14v2H0z" />
            </svg>
          </div>
        </el-tooltip>
        <el-tooltip content="左右翻转" placement="top" effect="light">
          <div ref="flipX" class="text" @click="handleFlipX()">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" class>
              <path
                fill-rule="evenodd"
                d="M0 6.999l4-4v8L0 7zM10.184 11V3l4 4-4 4zm-4.185 3V0H8v14H5.999z"
              />
            </svg>
          </div>
        </el-tooltip>
